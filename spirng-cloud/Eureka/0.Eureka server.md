...
public class EurekaBootStrap implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        try {
            // 初始化配置环境 主要返回 ConfiruatioManager
...
protected void initEurekaServerContext() throws Exception {
        ...
        if (eurekaClient == null) {
            // 加载Eureka.instance配置文件
            EurekaInstanceConfig instanceConfig = isCloud(ConfigurationManager.getDeploymentContext())
                    ? new CloudInstanceConfig()
                    : new MyDataCenterInstanceConfig();
            // 根据Eureka.instance配置文件 及 当前实例 创建 实例管理器来管理实例
            applicationInfoManager = new ApplicationInfoManager(
                    instanceConfig, new EurekaConfigBasedInstanceInfoProvider(instanceConfig).get());
            // 根据实例管理器及Eureka.client配置文件,创建EurekaClient 因为Eureka其自身如果在集群的话也是相当于Client
...
// （3）先是将eureka-server.properties中的配置加载到了一个Properties对象中，然后将Properties对象中的配置放到ConfigurationManager中去，此时    //     ConfigurationManager中去就有了所有的配置了
...
![image-20220125174852695](D:\学习\learn-docu\spirng-cloud\Eureka\0.Eureka server.assets\image-20220125174852695-16431041351571.png)
...
<img src="D:\学习\learn-docu\spirng-cloud\Eureka\0.Eureka server.assets\799093-20191226100224554-852172976.png" alt="799093-20191226100224554-852172976" style="zoom:65%;" />



# 2.核心类

## 2.1.EurekaServerAutoConfiguration
...
![799093-20191230100157542-1986591842](D:\学习\learn-docu\spirng-cloud\Eureka\0.Eureka server.assets\799093-20191230100157542-1986591842-16431825152091.png)





## 2.4.EurekaServerInitializerConfiguration

技术亮点：定时任务触发错误时间补偿机制

在做定时任务的时候，基于某个固定点触发的操作都可能由于一些其他原因导致固定的点没有执行对应的操作，这时再次执行定时操作后，计算的每次任务相隔时间就会出现问题。而Eureka 这里采用了一种补偿机制，再计算时间差值的时候完美解决此问题

Bug：如果客户端宕机，服务器至少180s才能将其剔除，其他客户端至少180s才能感知到其下线
...
![799093-20200104063201630-143273808](D:\学习\learn-docu\spirng-cloud\Eureka\0.Eureka server.assets\799093-20200104063201630-143273808.png)



![799093-20200104063205750-263272955](D:\学习\learn-docu\spirng-cloud\Eureka\0.Eureka server.assets\799093-20200104063205750-263272955-16432537748062.png)
...
参考： [Eureka源码](https://www.cnblogs.com/wang-meng/p/12147889.html)